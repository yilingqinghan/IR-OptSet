...
B0:
%6 = icmp sgt i32 %2, %4
br i1 %6, label %B5, label %B1
B1:
%7 = icmp sgt i32 %1, %3
br label %B2
B2:
%8 = phi i32 [ %2, %B1 ], [ %10, %B4 ]
br i1 %7, label %B4, label %B3
B3:
%9 = phi i32 [ %1, %B2 ], [ %11, %B3 ]
tail call void @gdImageSetPixel(ptr noundef %0, i32 noundef %9, i32 noundef %8, i32 noundef %5)
%10 = add i32 %8, 1
%11 = add i32 %9, 1
%12 = icmp eq i32 %9, %3
br i1 %12, label %B4, label %B3, !llvm.loop !5
B4:
%13 = icmp eq i32 %8, %4
br i1 %13, label %B5, label %B2, !llvm.loop !7
B5:
ret void
}
