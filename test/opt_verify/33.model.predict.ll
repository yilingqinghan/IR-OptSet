...
declare dso_local void @_ZN5PointC2Eeee(ptr noundef nonnull align 16 dereferenceable(48), x86_fp80 noundef, x86_fp80 noundef, x86_fp80 noundef) unnamed_addr #0 align 2
define dso_local void @_ZmlRK5Pointe(ptr dead_on_unwind noalias writable sret(%STRUCT0) align 16 %0, ptr nocapture noundef nonnull readonly align 16 dereferenceable(48) %1, x86_fp80 noundef %2) local_unnamed_addr #0 {
B0:
