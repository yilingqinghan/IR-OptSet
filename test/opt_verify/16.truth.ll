...
%4 = icmp eq i64 %3, 1
%5 = load i64, ptr @MOD, align 8, !tbaa !5
br i1 %4, label %B4, label %B5
B2:
%6 = phi i64 [ %14, %B5 ], [ %11, %B4 ]
%7 = srem i64 %6, %5
br label %B3
B3:
%8 = phi i64 [ 1, %B0 ], [ %7, %B2 ]
...
B4:
%9 = add nsw i64 %1, -1
%10 = tail call noundef i64 @_Z5powerxx(i64 noundef %0, i64 noundef %9)
%11 = mul nsw i64 %10, %0
br label %B2
B5:
%12 = sdiv i64 %1, 2
%13 = tail call noundef i64 @_Z5powerxx(i64 noundef %0, i64 noundef %12)
